...
- Язык: **Golang**
- Хранение данных: postgreSQL. Я сделал пользователя в своем облачном PG, чтобы ты мог не разворачивать бд локально.
  - хост 79.174.88.98
  - порт 15659
  - база данных db1
  - пользователь mitrofan
  - пароль dM:t-7I4!R+5w._w
...
- Можно использовать любые библиотеки/фреймворки (советую Gin)
